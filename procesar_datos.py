""" procesar_datos.py: Realiza el procesamiento de los datos"""
from logger import *                  # logging
import pandas as pd
# import numpy as np


def normalizar_datos(categoria, fullfilename):
    """
...
def registros_por_categoria(df):
    """
...
def registros_por_provincia_y_categoria(df):
    """
    Procesar los datos conjuntos para poder generar una tabla con la siguiente información:
...
def procesar_datos_cines(fullfilename):
    """
