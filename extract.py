""" extract.py: Obtener y guardar los archivos fuentes """
...
def crear_path_y_filename(categoria: str) -> str:
    """
    Crea path y filename para organizar los archivos en rutas siguiendo la siguiente estructura:
    ...
    :param categoria: categoria del archivo de datos ('museos', salas_de_cine')
    :return: filename: path y filename para el archivo de datos
    """
...
def guardar_fuente(url: str, fullfilename: str) -> None:
    """
    Obtiene los 3 archivos de fuente utilizando la librería requests y los almacena en forma local
    ...
    :param url: url de donde descargar los archivos de fuentes
    :param fullfilename: con que nombre guardar los archivos
    :return: nada, los archivos son grabados
    """
    try:
